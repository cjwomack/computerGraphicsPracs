...
class Renderer:
    ...
    def make_assets(self) -> None:
        ...
        self.framebuffer = Framebuffer(self.screenWidth, self.screenHeight)
...
class Framebuffer:
    ...
    def make_color_buffer(self, w: int, h: int) -> None:
        ...
        """
            TODO: generate a texture and bind it to as any regular 2D texture.
        """
        #preallocate space
        """
            TODO: send NULL data to the texture (this allocates space on the GPU)

            call glTexImage2D, just as if we were loading an image (except use GL_RGB instead of GL_RGBA),
            and pass in None as the data location.
        """
    ...
    def make_depth_stencil_buffer(self, w: int, h: int) -> None:
        ...
        """
            TODO: generate and bind a renderbuffer
        """
        #preallocate space, we'll use 24 bits for depth and 8 for stencil
        """
            TODO: achieve this with the glRenderbufferStorage function
        """
